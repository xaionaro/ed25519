...
int main(int argc, char ** argv) {
	...
	flg_v = 0, flg_k = 0, flg_K = 0, flg_n = 0, flg_x = 0;
    char * hex_secret = 0;
    char * hex_pub = 0;
	...
	if(opton && argv[ar][0] == '-' && argv[ar][1] != 0)
		...
		case 'L': printf("%s", LICENSE); exit(0);
...
Usage()
{
    ...
    fprintf(stderr, "    -t                   # Run some tests.\n");
    fprintf(stderr, "    -L                   # Print License and exit\n");
    fprintf(stderr, "\n");
...
void library_test() {
    ...
    printf("Signature: "); printhex(signature, sizeof(signature));
    ...
    printf("Add Scalar:"); printhex(scalar, sizeof(scalar));
    printf("Private:   "); printhex(private_key, sizeof(private_key));
    printf("Public:    "); printhex(public_key, sizeof(public_key));
    ...
    printf("Changed:   "); printhex(signature, sizeof(signature));
    printf("Here ...   %*s\n", i*2+2, "^^");
    ...
    printf("Seed 1:    "); printhex(seed, sizeof(seed));
    printf("Private 1: "); printhex(private_key, sizeof(private_key));
    printf("Public 1:  "); printhex(public_key, sizeof(public_key));

    ed25519_create_seed(seed);
    ed25519_create_keypair(other_public_key, other_private_key, seed);

    printf("Seed 2:    "); printhex(seed, sizeof(seed));
    printf("Private 2: "); printhex(other_private_key, sizeof(other_private_key));
    printf("Public 2:  "); printhex(other_public_key, sizeof(other_public_key));
    ...
    printf("Shared:    "); printhex(shared_secret, sizeof(shared_secret));
...
#if 0 /* Performance depends on OS */
    /* test performance */
    ...
    printf("%fus per seed\n", ((double) ((end - start) * 1000.0)) / CLOCKS_PER_SEC / i * 1000.0);
#endif
    ...
    printf("Scalar:    "); printhex(scalar, sizeof(scalar));
